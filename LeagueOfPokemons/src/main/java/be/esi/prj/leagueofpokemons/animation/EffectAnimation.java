...
/**
 * Class providing animations for different Pokemon effect types.
 */
public class EffectAnimation {
     ...
     *
     * @param pokemonImage The ImageView of the Pokemon to animate
     * @param parentPane The parent pane to add particle effects to
     * @param effectType The type of effect to animate
     */
    ...
    /**
     * Plays a red/orange flame effect animation for the BURN effect
     */
    ...
    /**
     * Plays a green healing effect animation for the DRAIN effect
     */
    ...
    /**
     * Plays a yellow/electric effect animation for the PARALYZE effect
     */
    ...
    /**
     * Plays an improved critical hit effect animation with cross shape
     */
    ...
    /**
     * Creates a cross-shaped slash effect
     */
